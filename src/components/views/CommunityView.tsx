...
export const CommunityView: React.FC = () => {
  ...
  // Approved posts visible to public, pending posts visible if author
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-emerald-100 shadow-sm relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-100 text-emerald-900 text-xs font-bold rounded-full mb-2">
            ...
            <p className="text-xs text-slate-600 mt-1 max-w-xl">
              Share experiences and offer gentle encouragement in a safe, moderated environment. All posts are reviewed by clinical operations before publication.
            </p>
          </div>

          <button
            onClick={() => setShowNewPostModal(true)}
            className="px-5 py-2.5 bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs rounded-2xl shadow-md flex items-center gap-2 transition-all shrink-0"
          >
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3">
                <img
                  ...
                  className="w-10 h-10 rounded-full border border-emerald-600 object-cover"
                />
                <div>
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3">
              ...
              <div className="flex items-center gap-2 pt-2">
                <input
                  ...
                  className="flex-1 px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-900 focus:bg-white focus:border-emerald-600 focus:outline-none"
                />
                <button
                  onClick={() => handleCommentSubmit(post.id)}
                  className="px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs rounded-xl shadow-2xs transition-all"
                >
                  Reply
                </button>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 max-w-lg w-full shadow-2xl border border-emerald-100 space-y-4">
            ...
            <form onSubmit={handleCreatePost} className="space-y-3">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-emerald-700 text-white font-bold text-xs rounded-xl shadow-xs"
                >
